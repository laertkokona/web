        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach($u_posts as $key => $u_post): ?>
                            <tr>
                                <td><?php echo $key + 1; ?></td>
                                <td><?php echo $u_post['title']; ?></td>
                                <td><?php echo $u_post['username'];?></td>
                                <td><a href="edit.php?id=<?php echo $u_post['id']; ?>" class="edit">Edit</a></td>
                                <td><a href="edit.php?delete_id=<?php echo $u_post['id']; ?>" class="delete">Delete</a></td>

                                <?php if ($u_post['published']): ?>
                                    <td><a href="edit.php?published=0&p_id=<?php echo $u_post['id'] ?>" class="unpublish">Unpublish</a></td>

                                <?php else: ?>
                                    <td><a href="edit.php?published=1&p_id=<?php echo $u_post['id'] ?>" class="publish">Publish</a></td>
                                <?php endif; ?>
